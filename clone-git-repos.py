...
if __name__ == '__main__':
    gh = pygithub3.Github(login='user ', password='psssword' )

    clone_urls = gather_clone_urls("organisation-name")
    counter = 0
    for url in clone_urls:
        #print url
        if "inf-ter-" in url and "-api-jva-" not in url and "-digital-app-" not in url:
            counter +=1
            print ("cloning repo " + url + "..........")
            os.system('git clone '+ url)
            print("cloned repo............................")

    print(" all repos ->  " + str(counter))
